    ...
    <div>
        ...
        <div class="card footer-update">
          <div class="card-header col-md-12 ">
            ...
            Employee Update 
            <router-link to="/given-salary" class="btn btn-sm btn-info" id="add_new"> All Employees for Pay</router-link>
          </div>
          <div class="card-body">
	          ...
	          <div class="form-group">
	              <div class="form-row">
	               <div class="col-md-6">
	                <div class="form-group">
                        <select class="form-control" id="supplier" v-model="form.salary_month" >
                           ...
                           <label for="supplier">Months</label>
